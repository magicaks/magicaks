...
echo "Service Application Id: $serverApplicationId"
echo "Server Application secret: $serverApplicationSecret"
echo "Client Application Id: $clientApplicationId"